<?php
    ...
    try {
        ...
        $mail->AltBody = 'É necessário que você utilize um client que suporte HTML para visualizar todo o conteúdo desta mensagem.';
        ...
        $mensagem->status['descricao_status'] = "Não foi possível enviar este email. Erro encontrado: {$mail->ErrorInfo}";
